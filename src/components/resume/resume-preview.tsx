                    ...
                    <div className="space-y-3">
                        {education.map((edu) => (
                            <div key={edu.id} className="break-inside-avoid-page">
                                <div className="flex justify-between items-baseline mb-1">
                                    <h3 className="font-bold text-base">{edu.institutionName}</h3>
                                    <span className="text-sm font-medium text-muted-foreground">
                ...
                {education.length > 0 && (
                    <div className="space-y-4">
                        ...
                        <div className="space-y-4 text-[#cbd5e1]">
                            {education.map((edu) => (
                                <div key={edu.id}>
                                    <div className="text-xs font-bold text-white mb-1">{edu.institutionName}</div>
    ...
    return (
        <div className="flex flex-row h-full font-sans">
            <div className="w-[36%] bg-gray-200 p-6 space-y-6 text-gray-800">
                ...
                {education.length > 0 && <div className="space-y-2"><h3 className="text-xs font-bold uppercase tracking-widest text-gray-600 border-b border-gray-400 pb-1">Education</h3>{education.map(edu => (<div key={edu.id} className="text-xs text-gray-700"><div className="font-bold">{edu.institutionName}</div><div>{edu.degree}</div><div className="opacity-70">{edu.startDate}{edu.endDate ? ` – ${edu.endDate}` : ''}</div></div>))}</div>}
...
const GrayCleanTemplate = ({ data }: { data: ResumeData }) => {
    ...
    return (
        <div className="flex flex-col space-y-6 font-sans">
            ...
            {education.length > 0 && <div><h2 className="text-sm font-bold text-gray-700 uppercase tracking-widest mb-1 pb-1" style={{ borderBottom: '1px solid #d1d5db' }}>Education</h2><div className="space-y-3 mt-2">{education.map(edu => (<div key={edu.id} className="flex justify-between items-baseline"><div><div className="font-bold text-gray-900 text-sm">{edu.institutionName}</div><div className="text-sm text-gray-600">{edu.degree}</div></div><span className="text-xs text-gray-400">{edu.startDate}{edu.endDate ? ` – ${edu.endDate}` : ''}</span></div>))}</div></div>}
    ...
    return (
        <div className="flex flex-col font-sans">
            ...
            <div className="flex flex-col space-y-5 px-8 py-6">
                ...
                {education.length > 0 && <div><h2 className="text-sm font-bold uppercase tracking-widest text-blue-700 border-b-2 border-blue-200 pb-1 mb-3">Education</h2><div className="space-y-3">{education.map(edu => (<div key={edu.id} className="flex justify-between"><div><div className="font-bold text-gray-900 text-sm">{edu.institutionName}</div><div className="text-sm text-gray-600">{edu.degree}</div></div><span className="text-xs text-gray-500">{edu.startDate}{edu.endDate ? ` – ${edu.endDate}` : ''}</span></div>))}</div></div>}
...
const BeigeMinimalTemplate = ({ data }: { data: ResumeData }) => {
    ...
    return (
        <div className="flex flex-col space-y-6" style={{ fontFamily: 'Georgia, serif', color: '#3d3530', backgroundColor: '#faf8f5', padding: '40px' }}>
            ...
            {education.length > 0 && <div><h2 className="text-xs uppercase tracking-[0.25em] mb-3 font-bold" style={{ color: '#9c8070', borderBottom: '1px solid #e0d5c8', paddingBottom: '4px' }}>Education</h2><div className="space-y-4">{education.map(edu => (<div key={edu.id}><div className="flex justify-between items-baseline"><span className="font-bold text-sm" style={{ color: '#3d3530' }}>{edu.institutionName}</span><span className="text-xs" style={{ color: '#9c8070' }}>{edu.startDate}{edu.endDate ? ` – ${edu.endDate}` : ''}</span></div><div className="text-sm italic" style={{ color: '#7a6355' }}>{edu.degree}</div></div>))}</div></div>}
...
const ExecutiveProfessionalTemplate = ({ data }: { data: ResumeData }) => {
    ...
    return (
        <div className="flex flex-col space-y-5 font-sans">
            ...
            {education.length > 0 && <div><h2 className="text-xs font-bold uppercase tracking-widest text-gray-900 mb-3 border-b border-gray-300 pb-1">Education</h2><div className="space-y-3">{education.map(edu => (<div key={edu.id} className="flex justify-between"><div className="w-3/4"><div className="font-bold text-gray-900 text-sm">{edu.institutionName}</div><div className="text-sm text-gray-700">{edu.degree}</div></div><span className="text-xs text-gray-600 font-medium whitespace-nowrap">{edu.startDate}{edu.endDate ? ` – ${edu.endDate}` : ''}</span></div>))}</div></div>}
...
const ElegantSerifTemplate = ({ data }: { data: ResumeData }) => {
    ...
    return (
        <div className="flex flex-col space-y-6" style={{ fontFamily: 'Merriweather, Georgia, serif', color: '#111827' }}>
            ...
            {education.length > 0 && <div><h2 className="text-lg font-bold uppercase tracking-widest text-black border-b border-gray-300 pb-2 mb-4 text-center">Education</h2><div className="space-y-4">{education.map(edu => (<div key={edu.id}><div className="flex justify-between items-baseline mb-1"><span className="font-bold text-black text-base">{edu.institutionName}</span><span className="text-sm font-sans font-medium text-gray-600">{edu.startDate}{edu.endDate ? ` – ${edu.endDate}` : ''}</span></div><div className="text-sm italic text-gray-800">{edu.degree}</div></div>))}</div></div>}
