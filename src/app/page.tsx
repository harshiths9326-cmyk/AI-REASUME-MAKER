    ...
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
        ...
        <div className="container px-4 md:px-6 mx-auto max-w-7xl">
          <div className="flex flex-col items-center space-y-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/builder">
                <Button size="lg" className="px-8 h-12 rounded-full font-semibold">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <Card className="bg-background/60 backdrop-blur border-none shadow-md">
              <CardHeader>
                ...
                <CardDescription>
                  Generate professional bullet points and summaries based on your raw input.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="bg-background/60 backdrop-blur border-none shadow-md">
              <CardHeader>
                ...
                <CardTitle>ATS-Friendly Designs</CardTitle>
                <CardDescription>
                  Clean, modern templates designed to pass Applicant Tracking Systems flawlessly.
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="bg-background/60 backdrop-blur border-none shadow-md">
              <CardHeader>
                ...
                <CardTitle>One-Click PDF Export</CardTitle>
                <CardDescription>
                  Download your polished resume instantly as a perfectly formatted PDF.
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="w-full py-24">
        <div className="container mx-auto px-4 md:px-6 max-w-7xl">
          ...
          <div className="grid gap-8 sm:gap-12 md:grid-cols-4 relative">
            ...
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center space-y-4">
                <div className="w-24 h-24 rounded-full bg-background border-4 border-primary flex items-center justify-center text-2xl font-bold text-primary shadow-lg">
                  {item.step}
                </div>
      ...
      <section className="w-full py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl text-center space-y-8">
          ...
          <Link href="/builder">
            <Button size="lg" variant="secondary" className="px-8 h-12 rounded-full font-bold text-primary">
